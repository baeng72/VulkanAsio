...
public:
	...
	void build(Vulkan::Buffer& buffer_, std::vector<uint32_t>& vertexLocations,void**ptr=nullptr);
...
public:
	...
	void build(Vulkan::Buffer& buffer_, std::vector<uint32_t>& indexLocations,void**ptr=nullptr);
...
class TextureLoader {
	...
	void loadCubeMap(std::vector<uint8_t*>& cubeArray, uint32_t width, uint32_t heigth, bool enableLod, Vulkan::Texture& image);
...
public:
	...
	~VulkanFramebufferList() { Vulkan::cleanupFramebuffers(device, frameBuffers); }
